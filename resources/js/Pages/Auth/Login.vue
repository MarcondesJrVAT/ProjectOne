            ...
            <div class="grid gap-6">
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="email" type="email" class="block w-full" placeholder="usuario@provedor.com" v-model="form.email" required autofocus autocomplete="username" />
                    </InputIconWrapper>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-600">Lembrar dados</span>
                    </label>
