            ...
            <div class="grid gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="email" type="email" class="block w-full" placeholder="usuário@provedor.com" v-model="form.email" required autocomplete="username" />
                    </InputIconWrapper>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="password_confirmation" type="password" class="block w-full" placeholder="Confirme a Senha" v-model="form.password_confirmation" required autocomplete="new-password" />
                    </InputIconWrapper>
                </div>
