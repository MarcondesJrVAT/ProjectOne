    ...
    <GuestLayout title="Redefinir Senha">
        ...
        <form @submit.prevent="submit">
            <div class="grid gap-4">
                <div class="space-y-2">
                    <Label for="email" value="Endereço de email" />
                    <InputIconWrapper>
                        <template #icon>
                            <MailIcon aria-hidden="true" class="w-5 h-5" />
                        </template>
                        <Input withIcon id="email" type="email" placeholder="usuario@provedor.com" class="block w-full" v-model="form.email" required autofocus autocomplete="username" />
                    </InputIconWrapper>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="password_confirmation" type="password" placeholder="Confirme a senha" class="block w-full" v-model="form.password_confirmation" required autocomplete="new-password" />
                    </InputIconWrapper>
                </div>
